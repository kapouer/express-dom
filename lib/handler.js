...
module.exports = class Handler {
	...
	static newheadless = process.env.PWHEADLESS;
	...
	#init() {
		...
		if (Handler.newheadless) {
			launchOptions.ignoreDefaultArgs = ['--headless', '--use-angle'];
			launchOptions.args = ['--headless=new', '--use-angle=' + Handler.newheadless];
		}
