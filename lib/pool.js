const WebKit = require('webkitgtk');
...
Pool.prototype.process = function() {
	...
	this.queues.forEach((queue, priority) => {
		let next, nextIndex = -1, oldest = Infinity;
